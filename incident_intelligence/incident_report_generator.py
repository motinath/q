...
class IncidentReportGenerator:
    ...
    def to_markdown(self, report: IncidentReport) -> str:
        ...
        md = []
        md.append(f"# VECTOR Q INCIDENT DOSSIER: `{report.incident_id}`")
        ...
        md.append("---")
        md.append("*Generated automatically by VECTOR Q Autonomous Quantum Operations Framework.*")
        return "\n".join(md)
    ...
    def export_pdf(self, report: IncidentReport, output_path: Optional[str] = None) -> bytes:
        ...
        if not REPORTLAB_AVAILABLE:
            raise RuntimeError("The 'reportlab' package is required for PDF export. Please install it via 'pip install reportlab'.")
        buffer = BytesIO()
        ...
        banner_content = [
            [
                Paragraph("<b>VECTOR Q | QUANTUM NETWORK FORENSIC DOSSIER</b>", title_style),
        ...
        story.append(Paragraph(
            "<b>Compliance & Governance Attestation:</b> Generated by VECTOR Q Autonomous Quantum Operations Framework. "
